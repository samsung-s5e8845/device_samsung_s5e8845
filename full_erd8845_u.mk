...
# build for erd8845 hardware. This cleanly combines a set of
# device-specific aspects (drivers) with a device-agnostic
# product configuration (apps). Except for a few implementation
# details, it only fundamentally contains two inherit-product
# lines, full and erd8845, hence its name.
#

#ifeq ($(TARGET_PRODUCT),full_erd8845_u)
...
$(call inherit-product, device/samsung/erd8845/device.mk)

PRODUCT_BOARD := erd8845
TARGET_DEVICE_NAME := erd8845
TARGET_SOC := s5e8845
TARGET_SOC_BASE := s5e8845
TARGET_BOOTLOADER_BOARD_NAME := s5e8845
TARGET_BOARD_PLATFORM := erd8845

PRODUCT_NAME := full_erd8845_u
PRODUCT_DEVICE := erd8845
PRODUCT_BRAND := Exynos
PRODUCT_MODEL := Full Android on S5E8845 ERD
