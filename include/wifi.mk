...
#device/samsung/erd8845/temp.sh:vendor/etc/wifi/temp.sh
...
#PRODUCT_COPY_FILES += device/samsung/erd8845/wpa_supplicant.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wpa_supplicant.conf
