...
PRODUCT_COPY_FILES += \
	...
	device/samsung/erd8845/init.exynos.nanohub.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.exynos.sensorhub.rc \
	frameworks/native/data/etc/android.hardware.sensor.stepcounter.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.sensor.stepcounter.xml \
	frameworks/native/data/etc/android.hardware.sensor.stepdetector.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.sensor.stepdetector.xml \
# Copy CHUB os binary files
ifneq ("$(wildcard device/samsung/erd8845/firmware/os.checked*.bin)", "")
PRODUCT_COPY_FILES += $(foreach image,\
    $(wildcard device/samsung/erd8845/firmware/os.checked*.bin),\
	$(image):$(TARGET_COPY_OUT_VENDOR)/firmware/$(notdir $(image)))
else
PRODUCT_COPY_FILES += \
	#device/samsung/erd8845/firmware/chub_nanohub_0.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/os.checked_0.bin \
	#device/samsung/erd8845/firmware/chub_nanohub_1.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/os.checked_1.bin
endif

# Copy CHUB os elf file
ifneq ("$(wildcard device/samsung/erd8845/firmware/os.checked*.elf)", "")
PRODUCT_COPY_FILES += $(foreach image,\
    $(wildcard device/samsung/erd8845/firmware/os.checked*.elf),\
